...
import fuzs.puzzlesworkshop.client.renderer.entity.BabyStrayRenderer;
...
public class TinySkeletonsExtension extends ElementExtension<TinySkeletonsElement> implements IClientElement {
    ...
    public void setupClient2() {
        ...
        entityRenderDispatcher.register(TinySkeletonsElement.BABY_STRAY_ENTITY, new BabyStrayRenderer(entityRenderDispatcher));
    }
}
