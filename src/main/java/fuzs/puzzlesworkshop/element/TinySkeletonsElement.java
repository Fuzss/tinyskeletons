...
public class TinySkeletonsElement extends ClientExtensibleElement<TinySkeletonsExtension> {
    ...
    public void constructCommon() {
        ...
        PuzzlesLib.getRegistryManager().registerEntityType("baby_stray", () -> EntityType.Builder.of(BabyStrayEntity::new, EntityClassification.MONSTER).sized(0.6F, 1.99F).clientTrackingRange(8).build("baby_stray"));
    }
