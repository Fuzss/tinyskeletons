...
public class ModRegistry {
    ...
    public static final RegistryObject<EntityType<BabyStray>> BABY_STRAY_ENTITY_TYPE = REGISTRY.registerRawEntityType("baby_stray", () -> EntityType.Builder.of(BabyStray::new, MobCategory.MONSTER).sized(0.6F, 1.99F).immuneTo(Blocks.POWDER_SNOW).clientTrackingRange(8));
