    ...
    public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, T livingEntity, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
        ...
        if (!itemstack.isEmpty()) {
            ...
            if (livingEntity.getMainArm() == HumanoidArm.RIGHT) {
                this.renderArmWithItem(livingEntity, itemstack, ItemDisplayContext.THIRD_PERSON_RIGHT_HAND, HumanoidArm.RIGHT, poseStack, multiBufferSource, packedLight);
            } else {
                this.renderArmWithItem(livingEntity, itemstack, ItemDisplayContext.THIRD_PERSON_LEFT_HAND, HumanoidArm.LEFT, poseStack, multiBufferSource, packedLight);
            }
            poseStack.popPose();
        }
    }
