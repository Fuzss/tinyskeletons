...
public class TinySkeletonsClient implements ClientModConstructor {
    ...
    public void onAddResourcePackFinders(PackRepositorySourcesContext context) {
        context.addRepositorySource(PackResourcesHelper.buildClientPack(BabySkeletonPackResources::new, TinySkeletons.MOD_ID, new TextComponent(TinySkeletons.MOD_NAME), new TextComponent("Teeny, tiny skeletons, send shivers down your spine..."), true, false));
    }
}
