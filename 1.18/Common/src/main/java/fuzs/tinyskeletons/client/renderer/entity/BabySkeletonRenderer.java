...
public class BabySkeletonRenderer extends MobRenderer<AbstractSkeleton, SkeletonModel<AbstractSkeleton>> {
   ...
   public BabySkeletonRenderer(EntityRendererProvider.Context context, ModelLayerLocation entityLocation, ModelLayerLocation innerArmorLocation, ModelLayerLocation outerArmorLocation) {
      ...
      this.addLayer(new MainHandItemLayer<>(this, Minecraft.getInstance().getItemInHandRenderer()));
      this.addLayer(new BackItemLayer<>(this, Minecraft.getInstance().getItemInHandRenderer()));
      this.addLayer(new HumanoidArmorLayer<>(this, new SkeletonModel<>(context.bakeLayer(innerArmorLocation)), new SkeletonModel<>(context.bakeLayer(outerArmorLocation))));
   }
